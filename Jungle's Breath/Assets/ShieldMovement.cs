...
public class ShieldMovement : MonoBehaviour
{
    ...
    private bool slidingR, slidingL;
    ...
    void Update()
    {
        ...
        slidingL = GameObject.Find("Player").GetComponent<PlayerController>().slidingL;
        slidingR = GameObject.Find("Player").GetComponent<PlayerController>().slidingR;
